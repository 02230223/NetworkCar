	...
	<view class="code-area">
		<view class="flex-box">
			<input
				...
				@input="getVal"
			/>
			<view v-bind:class="['item', { active: codeIndex == 1 }]" style="color: #FFFFFF;">
			...
			<view v-bind:class="['item', { active: codeIndex == 2 }]" style="color: #FFFFFF;">
				<view class="line"></view>
			...
			<view v-bind:class="['item', { active: codeIndex == 3 }]" style="color: #FFFFFF;">
				<view class="line"></view>
			...
			<view v-bind:class="['item', { active: codeIndex == 4 }]" style="color: #FFFFFF;">
				<view class="line"></view>
